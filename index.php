        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_product t1 
                    ...
                    WHERE p_is_active=1 AND p_is_featured=1 AND t4.tcat_id!=6 LIMIT ".$total_featured_product_home);
...
<form action="">
            <p><a href="assets/uploads/<?php echo $row['p_featured_photo'];?>"  name="download" Download>Download</a></p>
            <p><a href="Cindex.php?id=<?php echo $row['p_id']; ?>">customize</a></p>
 </form>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    /*SELECT * FROM tbl_product WHERE p_is_active=?*/
                    $statement = $pdo->prepare(" SELECT * FROM tbl_product t1 
                    JOIN tbl_end_category t2 
                    ON t1.ecat_id = t2.ecat_id 
                    JOIN tbl_mid_category t3 
                    ...
                    JOIN tbl_top_category t4 
                    ON t3.tcat_id = t4.tcat_id 
                    WHERE p_is_active=1 and t4.tcat_id!=6 ORDER BY p_id DESC LIMIT ".$total_latest_product_home);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    JOIN tbl_top_category t4 
                    ON t3.tcat_id = t4.tcat_id 
                    WHERE p_is_active=1 and t4.tcat_id=6 
                    ORDER BY p_total_view DESC LIMIT ".$total_popular_product_home);
                    $statement->execute(array(1));
                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);                            
                    foreach ($result as $row) {
                        ?>
