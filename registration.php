...
<a href="'.$verify_link.'">'.$verify_link.'</a>';
        ...
        $success_message = "You are successfully registered with Blooz!!";
    }
}
?>

<div class="page-banner" style="background-color: #C0B8DD;border-color:  #BED4E9;background-image: url(assets/uploads/<?php echo $banner_registration; ?>);">
    <div class="inner">
