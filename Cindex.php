<?php require_once('C:\xampp\htdocs\eCommerceSite-PHP\connection.php'); ?>
<?php
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Cassets/css/main.css?v23">
                    ...
                    <section id="drawing" class="tab" data-index="3" ng-controller="DrawingController">
                        ...
                        <div id="brushes">
                            <div ng-repeat="brush in drawing.availableBrushes" ng-class="{ active: drawing.activeBrushName == brush }" class="brush" ng-click="changeBrush(brush, $event)">
                                <img title="{{ brush }}" class="img-responsive" ng-src="Cassets/images/brushes/{{brush}}.png"/>
                            </div>
                        </div>
                        ...
                        <div class="filters-list row" ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light">
                            <figure ng-class="{ applied: filters.filterAlreadyApplied(filter.name) }" ng-repeat="filter in filters.all" ng-click="filters.applyFilter(filter)" class="filter col-sm-6">
                                <div class="filter-image">
                                    <img ng-src="Cassets/images/filters/{{ filter.name.toLowerCase() }}.png" class="img-responsive md-whiteframe-z1"/>
                            ...
                            <section ng-repeat="category in categories" class="sticker-category-container">
                                ...
                                <div class="category-stickers" ng-class="{ 'open animated slideInDown': activeCategory === category.name, 'dark-bg': category.darkbg }">
                                    <div ng-repeat="doodle in category.items track by $index" ng-click="addToCanvas(category, $index+1, $event)" class="sticker">
                                        <img class="img-responsive" data-src="Cassets/images/stickers/{{category.name}}/{{$index+1}}.{{ category.type }}"/>
                                    </div>
                                </div>
                            </section>
                        </div>
...
<form action="index.php" method="POST">
                    <md-button type="submit" name="back" value="back" class="md-primary md-raised">back</md-button></form>
</br>
                    <md-button ng-click="openSaveDialog($event)" class="md-primary md-raised" id="save" name="save">Save</md-button>
                    <a href="c_product.php?id=<?php echo $row['p_id']; ?>"><md-button  class="md-primary md-raised" id="buy" name="buy" >Buy</md-button></a>
                </section>
            ...
            <script src="Cassets/js/scripts.min.js?v23"></script>
            ...
            <script type="application/ng-template" id="gradient-sheet-template">
                <md-bottom-sheet class="bottom-sheet gradients-sheet">
                    <div class="items-list" ed-pretty-scrollbar>
                        <div ng-repeat="g in shapes.gradients" ng-style="{background: 'url(Cassets/images/gradients/'+($index+1)+'.png)'}" ng-click="shapes.fillWithGradient($index+1)" class="item md-whiteframe-z1"></div>
                    </div>
                </md-bottom-sheet>
            </script>
            ...
            <script type="application/ng-template" id="image-sheet-template">
                <md-bottom-sheet class="bottom-sheet images-sheet">
                    ...
                    <div class="items-list" ed-pretty-scrollbar>
                        <div ng-repeat="t in shapes.textures track by $index" ng-style="{background: 'url(Cassets/images/textures/'+$index+'.png)'}" ng-click="shapes.fillWithImage('assets/images/textures/'+$index+'.png')" class="item md-whiteframe-z1"></div>
                    </div>
                </md-bottom-sheet>
            </script>
                    ...
                    <md-button type="submit" name="back" value="back" class="md-primary md-raised">back</md-button></form>
                            ...
                            <div ng-show="canOpenImage">
                               ...
                               ?>
                                ...
                                <!--<div class="buttons">
                                     <md-button ng-click="openImage()" name="open" value="open" class="md-primary md-raised">Open</md-button>
