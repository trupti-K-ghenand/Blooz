            ...
            <form action="" method="post" enctype="multipart/form-data">
				...
				<div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        <tr>
                            ...
                            <th class="text-center" style="width: 100px;">Customized Image</th>
                            <th><?php echo LANG_VALUE_47; ?></th>
                            <th><?php echo LANG_VALUE_157; ?></th>
                            <th><?php echo LANG_VALUE_158; ?></th>
                            <th><?php echo LANG_VALUE_159; ?></th>
                            <th>customization cost</th>
                        ...
                        $table_total_price = 0;
                        $i=0;
                        foreach($_SESSION['cart_photo'] as $key => $value) 
                        {
                            $i++;
                            $arr_cart_photo[$i] = $value;
                        }
                        $i=0;
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <img src="assets/c_uploads/<?php echo  $arr_cart_photo[$i]; ?>" alt="">
                            ...
                            <td><?php echo LANG_VALUE_1; ?><?php echo $c_cost; ?></td>
                            <td>
                            ...
                            <td class="text-right">
                                <?php
                                $row_total_price = $c_cost*$arr_cart_p_qty[$i]+($arr_cart_p_current_price[$i]*$arr_cart_p_qty[$i]);
                            ...
                            <td class="text-center">
                                <a onclick="return confirmDelete();" href="c_cart-item-delete.php?id=<?php echo $arr_cart_p_id[$i]; ?>&size=<?php echo $arr_cart_size_id[$i]; ?>&color=<?php echo $arr_cart_color_id[$i]; ?>" class="trash"><i class="fa fa-trash" style="color:red;"></i></a>
                            </td>
                        ...
                        <tr>
                            <th colspan="9" class="total-text">Total</th>
                ...
                <div class="cart-buttons">
                    <ul>
                        ...
                        <li><a href="c_checkout.php" class="btn btn-primary"><?php echo LANG_VALUE_23; ?></a></li>
                    </ul>
                </div>
