...
<div class="page">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                            ...
                                            <option value="upi"><!--<?php echo LANG_VALUE_38; ?>-->UPI</option>
	                                    </select>
	                                </div>
                                    ...
                                    <!--<form action="payment/upi/qr.php" method="post" id="upi_form">
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for=""><?/*php echo LANG_VALUE_43; */?>Scan this QR Code</span></label><br>
                                            <div>
                                                <img scr="payment\upi\QR.jpg" width="300" height="300">
                                            </div>
                                            <?php/*
                                            $statement = $pdo->prepare("SELECT * FROM tbl_settings WHERE id=1");
                                            $statement->execute();
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AaxcJLQLsyMFxssevSzW-fxGSj5DoAYocTjf3BXC00rIcuKt573GHD8U5fuu2lumPO3o9V1UlFoZ97Oi&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
  <script>
      ...
      paypal.Buttons({
        ...
        createOrder: function(data, actions) {
          return actions.order.create({
            purchase_units: [{"description":"crop top","amount":{"currency_code":"USD","value":115,"breakdown":{"item_total":{"currency_code":"USD","value":15},"shipping":{"currency_code":"USD","value":100},"tax_total":{"currency_code":"USD","value":0}}}}]
          });
        },
...
<input type="hidden" name="hosted_button_id" value="GGFK6CP42TTKG">
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
                                    ...
                                    -->
                                        ...
                                        <!--<p><a type="button" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=T869QRJBWPASN" class="btn btn-outline-light"> Purchase </a></p>      -->  
