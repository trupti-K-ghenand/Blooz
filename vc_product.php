...
if(!isset($_REQUEST['id'])) {
    ...
    $statement = $pdo->prepare("SELECT * FROM tbl_product  t1 JOIN tbl_c t2 ON t2.p_id=t1.p_id WHERE t2.p_id=?");
...
if(isset($_POST['form_add_to_cart'])) {
    header('location: c_cart.php?id='.$_REQUEST['id']);
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart.';
            ...
            $_SESSION['cart_photo'][$new_key] = $_POST['photo'];
    ...
    else
    {
        ...
        $_SESSION['cart_photo'][1] = $_POST['photo'];
        $success_message1 = 'Product is added to the cart successfully!';
    }
	endif;
}
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <div ><h4>Customized Product</h4></div>
                            <form action="" method="post">
                            <div class="p-quantity">
                                <div     class="row">

                                    <?php if(isset($size)): ?>
                                    <div  style="float:right;margin-left:14%;" class="col-md-5">
                                    ...
                                    <?php if(isset($color)): ?>
                                    <div style="float:right;margin-left:14%;padding-top:10px;" class="col-md-5">
                                    ...
                                    <div align="right" style="width:250px;height:140px;padding-top:10px;" class="box-body">
                                    <div class="form-group">      
                                       <?php
                                       $statement = $pdo->prepare("SELECT * FROM tbl_product  t1 JOIN tbl_c t2 ON t2.p_id=t1.p_id");
                                       $statement->execute();
                                       $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                       foreach ($result as $row) {
                                                               ?>   
                                        ...
                                        ?>
                                       <img src="assets/c_uploads/<?php echo $row['photo']; ?>" style="border: solid 2px black" width="400px" height="400px">
                                    </div>
                                    </div>
                                    <?php endif; ?>
							...
							<div class="p-quantity">
                                <div style="float:right;margin-left:14%;padding-top:30px;" class="col-md-5">
                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a href="vc_product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?></a></h3>
                                <h4>
                                ...
                                <p><a href="vc_product.php?id=<?php echo $row['p_id']; ?>"><?php echo LANG_VALUE_154; ?></a></p>
                            </div>
                        </div>
                        <?php
                    }
