            ...
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="9" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                        ...
                        ?>
                        <tr>
                            <td colspan="9" class="total-text"><?php echo LANG_VALUE_84; ?></td>
                            <td class="total-amount"><?php echo LANG_VALUE_1; ?> <?php echo $shipping_cost; ?></td>
                        </tr>
                        <tr>
                            <th colspan="9" class="total-text"><?php echo LANG_VALUE_82; ?></th>
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><a href="c_cart.php" class="btn btn-primary"><?php echo LANG_VALUE_21; ?></a></li>
                    </ul>
                </div>
