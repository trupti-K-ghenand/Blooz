				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <input type="submit" value="<?php echo LANG_VALUE_154; ?>" name="form_add_to_cart"><br><br>
                            <?php  $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_id=?");
                                    $statement->execute(array($_REQUEST['id']));
                                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);                                        
                                    foreach ($result as $row){
                                                                       ?>
                                                 ...
                                                 <form>
                                                 <p><a href="assets/uploads/<?php echo $row['p_featured_photo'];?>"  name="download" Download>Download</a></p><br>
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_154; ?></a></p>
                                                    <form> <p><a href="Cindex.php?id=<?php echo $row['p_id']; ?>">Customize</a></p></form>
                                <!--
