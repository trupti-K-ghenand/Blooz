<?php require_once('C:\xampp\htdocs\eCommerceSite-PHP\header.php'); ?>
					...
					<div class="row">
						...
						<div class="col-md-7">
                            ...
                            <!--<div class="btn-cart btn-cart1">
                                <input type="submit" value="VIEW" name="form_add_to_cart">
							</div>-->
                            </div>
                                    </div>                             
<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxnew-->                         
                            </form>
                            <?php include 'nc_cart.php';?>
							<div class="share">
								...
								<div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <input type="submit" class="btn btn-default" name="form_review" value="VIEW">
                                            </form>
                                            <?php else: ?>
